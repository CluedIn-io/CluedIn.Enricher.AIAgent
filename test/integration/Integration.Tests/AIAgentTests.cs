...
namespace CluedIn.ExternalSearch.AIAgent.Integration.Tests
{
    public class AIAgentTests : BaseExternalSearchTest<AIAgentExternalSearchProvider>
    {
        private readonly ITestOutputHelper outputHelper;

        public AIAgentTests(ITestOutputHelper outputHelper)
        {
